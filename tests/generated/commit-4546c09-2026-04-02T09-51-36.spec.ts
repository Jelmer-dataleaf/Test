...
test.describe("Login form", () => {
  ...
  test("shows minlength validation for short username and password", async ({
    page,
  }) => {
  ...
  test("submits successfully with valid credentials and remember me checked", async ({
    page,
  }) => {
  ...
  test("sign out resets the form state after successful login", async ({
    page,
  }) => {
